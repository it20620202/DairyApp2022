            ...
            public void onDelete(String noteKey, String Topic, int position) {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(ShowNote.this,"Task completed!", Toast.LENGTH_LONG).show();
                ...
                @Override
                public void onUpdate(String Date, String Topic, String noteKey, int position) {

                    Intent updateNote = new Intent(ShowNote.this,UpdateNote.class);
                    updateNote.putExtra("noteKey",noteKey);
                    updateNote.putExtra("Date", Date);
                    updateNote.putExtra("Topic", Topic);
